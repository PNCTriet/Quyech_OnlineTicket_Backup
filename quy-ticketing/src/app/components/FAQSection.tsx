...
const FAQS = [
  ...
  },
  {
    ...
    "a": { "vi": "Hãy kiểm tra kỹ các hộp thư, nếu vẫn không thấy, bạn có thể liên hệ chúng tôi qua FANPAGE QUYECH OFFICIAL/HOTLINE 093 478 2703 ( Ngọc Hân ) để được hỗ trợ.", "en": "Please check all your email folders carefully. If you still don't see it, you can contact us via FANPAGE/HOTLINE for support." }
  },
  {
